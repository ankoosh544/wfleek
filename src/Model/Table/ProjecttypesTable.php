 ...
 * @method \App\Model\Entity\Projecttype newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Projecttype[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Projecttype|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Projecttype[] patchEntities($entities, array $data, array $options = [])
