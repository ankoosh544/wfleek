    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $designation->has('department') ? $this->Html->link($designation->department->id, ['controller' => 'Departments', 'action' => 'view', $designation->department->id]) : '' ?></td>
                <td><?= h($designation->name) ?></td>
                <td><?= h($designation->isDeleted) ?></td>
                <td class="actions">
