        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav nav-tabs nav-tabs-bottom">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/groups/notes/<?= $group->id ?>">Notes</a></li>
                </ul>
            ...
            <div class="col-lg-12">
                <div class="row">
                                        ...
                                        <div class="card" style="width:100%;">
                                            <div class="card-body">
                                                ...
                                                <div class="row" style="height: 25px;">
                                                    <div class="likecount" id="postlikes_<?= $post->id ?>">
                                                        ...
                                                        <?php if (!empty($post->postlikes)) : ?>
                                                            ...
                                                            <a style=" text-decoration: underline;cursor: pointer;" data-toggle="modal" data-target="#post_likedpeople_<?= $post->id ?>" style="cursor: pointer;">Peoples</a>
                                                ...
                                                <div class="comments-mainsection" id="cmts_<?= $post->id ?>">
                                                    <?php if (!empty($post->postcomments)) : ?>
                                                                ...
                                                                <div class="row" style="height: 25px;">
                                                                    <div class="commentlikescount" id="commentlikes_<?= $postcomment->id ?>">
                                                                        ...
                                                                        <?php if (!empty($postcomment->postcommentlikes)) : ?>
                                                                            ...
                                                                            <a data-toggle="modal" data-target="#comment_likedpeople_<?= $postcomment->id ?>" style="cursor: pointer;text-decoration: underline;">Peoples</a>
                                                            ...
                                                            <div style="display: flex;">
                                                                ...
                                                                <div class="btn-file" style="padding:10px">
                                                                    <a data-toggle="modal" data-target="#tagpeople">
                                                                        <input class="form-control" accept="image/jpeg,image/jpg,image/gif,image/png" name="images" type="file" multiple />
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group form-focus select-focus m-b-30">
                                                                ...
                                                                <select id="tagusers" class="select2-icon floating" name="users" multiple>
                    ...
                    <div class="col-lg-3 col-md-3">
                        ...
                        <?php if (!empty($group->groupmembers)) : ?>
...
<script>
            ...
            success: function(data) {
                ...
                if (data['post'].postlikes.length > 0) {
                    str = '<span class="iconify" data-icon="uiw:like-o" style="color: blue;"></span>' +
                        ...
                        ' <a data-toggle="modal" data-target="#post_likedpeople_' + postid + '" style="cursor: pointer;text-decoration: underline;">Peoples</a>' +
            ...
            success: function(data) {
                ...
                if (data['count'] != 0) {
                    ...
                    str += '<span class="iconify" data-icon="uiw:like-o" style="color: blue;"></span>' +
                        ...
                        ' <a data-toggle="modal" data-target="#comment_likedpeople_' + commentid + '" style="cursor: pointer;text-decoration: underline;">Peoples</a>' +
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data['count'] != 0) {
                    str += '<span class="iconify" data-icon="uiw:like-o" style="color: blue;"></span>' +
                        '<span>' + data['count'] + '</span>' +
                        ' <a data-toggle="modal" data-target="#reply_likedpeople_' + reply_id + '" style="cursor: pointer;text-decoration: underline;">Peoples</a>' +
    ...
    function addFavourite(postid, userid, group_id) {
        $.ajax({
            ...
            success: function(data) {
                window.location = '/groups/notes/' + group_id;
