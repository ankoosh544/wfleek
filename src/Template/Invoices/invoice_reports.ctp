            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="/invoices/invoicecategoryview?companyId=<?= $companyId ?>&&status=<?= 'UnPaid' ?>" class="btn btn-info"> Un-Paid Invoices</a>
                    </div>
                    <div class="col-auto float-right ml-auto">
                        <a href="/invoices/invoicecategoryview?companyId=<?= $companyId ?>&&status=<?= 'Paid' ?>" class="btn btn-info"></i>Paid Invoices</a>
                    </div>
                </div>
