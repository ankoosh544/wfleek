                    ...
                    <div class="col-lg-9 col-md-9">
                        ...
                        <form method="post" action="/groupposts/add/<?= $group->id ?>" enctype="multipart/form-data">
                            <div class="postmessage-form" id="toggablediv">
                                ...
                                <div class="form-group form-focus select-focus m-b-30 tagpeopledive" style="display: none;">
                                    ...
                                    <span class="btn-file form-group" id="file-button" style="padding:10px">
                        ...
                        <div class="groupposts-block">
                            <section>
                                ...
                                <?php foreach ($group->groupposts as $post) : ?>
                                    <div class="card" id="cardsettings">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="post-area">
                                                    <p>
                                                        <?= nl2br($post->post_data) ?>
                                                    </p>
                                                </div>


                                                <?php if (!empty($post->grouppostfiles)) : ?>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="/grouppostfiles/downloadfile/<?= $file->id ?>">
                                                                        ...
                                                                        <?php elseif ($ext == 'jpg') : ?>
                                                                            <img class="uploaded-image" src="/<?= $file->filepath ?>/<?= $file->filename ?>" alt="">
                                                                        <?php else : ?>
                                            ...
                                            <div class="input-block">
                                                <div style="padding: 10px;display:flex;">
                                                    ...
                                                    <div class="postmessage-form" style="width:100%">
                                                        <div>
                                                        ...
                                                        <div class="form-group form-focus select-focus m-b-30 tagcommentdiv" id="tagpeoplecommentdiv_<?=$post->id?>" style="display: none;">
                                                            <img id="input_img" src="/assets/img/group.png" alt="" style="width: 20px;">
                                                            ...
                                                            <span class="btn-file" id="file-button" style="padding:10px">
                                                                <input class="form-control" accept="image/jpeg,image/jpg,image/gif,image/png" id="images_<?= $post->id ?>" name="images" type="file" multiple />
                                                                <img src="/assets/img/upload.png" alt="" style="width: 20px;">
                                                            </span>
                                                            <button type="submit" class="btn btn-info" id="post-button" onclick="postcomment(<?= $post->id ?>, <?= $authuser->id ?>)">Post</button>
...
<script>
    ...
    function postliked(postid, userid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var str = "";
                if (data['post'].postlikes.length > 0) {
                    str = '<span class="iconify" data-icon="uiw:like-o" style="color:blue;"></span>' +
                        '<span>' + data['post'].postlikes.length + '</span>' +
                        ' <a class="likedpeoples" data-toggle="modal" data-target="#post_likedpeople_' + postid + '" >Peoples</a>' +
                        ' <div class="modal custom-modal fade" id="post_likedpeople_' + postid + '" role="dialog">' +
                        '<div class="modal-dialog modal-dialog-centered">' +
                        '<div class="modal-content">' +
                        '<div class="modal-body">' +
                        '<div class="form-header">' +
                        ...
                        '<h3>Members</h3>' +
                        '</div>';
                    data['post'].postlikes.forEach((like) => {
                        str += '<div class="card">' +
                            '<h4 class="table-avatar">';
                        if (like.user.profileFilepath != null && like.user.profileFilename) {
                            str += '<a href="/user/view/' + like.user.id + '" class="avatar"><img src="' + like.user.profileFilepath + '/' + like.user.profileFilename + '" alt=""></a>';
                        } else {
                            str += '<a href="/user/view/' + like.user.id + '" class="avatar"><img src="/assets/img/profiles/avatar-21.jpg" alt=""></a>';
                        }
                        str += '<a href="/user/view/' + like.user.id + '">' + like.user.firstname + ' ' + like.user.lastname +
                            '</a>' +
                            '</h2>' +
                            '</div>';
                    });
    ...
    function renderMessages(data, postid, userid) {
        $('#cmts_' + postid).empty();
        var str = "";
        data.forEach((postcomment) => {
            str += '<div class="comment-section">' +
                ...
                '</div>' +
                '<div class="form-group">' +
                '<a href="#" data-toggle="tooltip" title="' + postcomment.user.firstname + ' ' + postcomment.user.lastname + '">';
            if (postcomment.user.profileFilepath != null && postcomment.user.profileFilename != null) {
                str += '<img alt="" src="' + postcomment.user.profileFilepath + '/' + postcomment.user.profileFilename + '" style=" width: 10%;">';
            } else {
                str += '<img alt="" src="/assets/img/profiles/avatar-16.jpg" style="width: 10%;">';
            }
            str += '</a>' +
                '<label>' + postcomment.user.firstname + ' ' + postcomment.user.lastname + ' </label>' +
                '</br>' +
                '<div class="form-control" contenteditable="true" id="editcomment_message_' + postcomment.id + '"> ' + postcomment.comment_data + '</div>' +
                '</div>' +
                '<div class="form-group">' +
                ' <input class="form-control" accept="image/jpeg,image/jpg,image/gif,image/png"  id="editcommentfiles" name="editcommentfiles" type="file" />' +
                '</div>' +
                '<div class="row">' +
                '<div class="col-6">' +
                '<button style="width: 100%;" type="submit" onclick="updatecomment(' + postcomment.id + ',' + postcomment.group_id + ',' + postcomment.post_id + ',' + userid + ')" class="btn btn-primary continue-btn">post</button>' +
                '</div>' +
                '<div class="col-6">' +
                '<a href="javascript:void(0);" data-dismiss="modal" class="btn btn-primary cancel-btn">Cancel</a>' +
                '</div>' +
            ...
            if (postcomment.user.profileFilepath != null && postcomment.user.profileFilename != null) {
                ...
                str += '<img alt="" src="/assets/img/profiles/avatar-16.jpg" style="width:25px ;">';
            }
            str += '</a>' +
                '</div>' +
                '<div class="form-control" style="border-radius: 24px;">' +
            ...
            if (postcomment.groupposttagmembers.length > 0) {
                str += '<span style="color: rgb(34 32 32 / 50%);"> -in Comment to </span>';
                postcomment.groupposttagmembers.forEach((tagmember) => {
                    if (tagmember.isComment == true) {
                        str += '<a href="/user/view/' + tagmember.user.id + '">' + tagmember.user.firstname + ' ' + tagmember.user.lastname + '</a>  ';
                    }
                });
            }
            str += '</br>' +
                '<p>' + postcomment.comment_data + '</p>';
            if (postcomment.postcommentfiles.length > 0) {
            ...
            if (postcomment.creation_date != null) {
                str += '<span class="chat-time">Posted At ' + postcomment.creation_date + '</span>';
            }
            str += '</div>' +
                '</div>' +
                ' <div class="row" style="height: 25px;" id="commentlikes_' + postcomment.id + '">';
            if (postcomment.postcommentlikes.length > 0) {
                str += '<div style="display: flex;" class="commentlikescount" >' +
                    '<span class="iconify" data-icon="uiw:like-o" style="color:blue;"></span>' +
                    '<p>' + postcomment.postcommentlikes.length + '</p>' +
                    '<a class="likedpeoples" data-toggle="modal" data-target="#comment_likedpeople_' + postcomment.id + '" >Peoples</a>' +
                    '</div>' +
                    '<div class="modal custom-modal fade" id="comment_likedpeople_' + postcomment.id + '" role="dialog">' +
                    '<div class="modal-dialog modal-dialog-centered">' +
                    ...
                    '<h3>Members</h3>' +
                    '</div>' +
                    postcomment.postcommentlikes.forEach((like) => {
                        str += '<div class="card">' +
                            '<h4 class="table-avatar">';
                        if (like.user.profileFilepath != null && like.user.profileFilename) {
                            str += '<a href="/user/view/' + like.user.id + '" class="avatar"><img src="' + like.user.profileFilepath + '/' + like.user.profileFilename + '" alt=""></a>';
            ...
            str += '</div>' +
                ...
                '<a  href="#reply_' + postcomment.id + '" style="cursor: pointer;color:black" onclick="showreplyform(' + postcomment.id + ');">Reply</a>';
            if (postcomment.postcommentlikes.length > 0) {
                postcomment.postcommentlikes.forEach((commentlike) => {
                    if (commentlike.comment_id == postcomment.id && commentlike.isLiked == true && commentlike.user_id == userid) {
                        str += '<a class="liked-botton  likebuttoncss" id="commentlike_' + postcomment.id + '" onclick="addcommentlike(' + postcomment.id + ',' + userid + ',' + postid + ')">Like</a>';
                    } else {
                        str += '<a class="unliked-botton likebuttoncss" id="commentlike_' + postcomment.id + '" onclick="addcommentlike(' + postcomment.id + ',' + userid + ',' + postid + ')">Like</a>';
                    }
                });
            } else {
                str += '<a class="unliked-botton likebuttoncss" id="commentlike_' + postcomment.id + '"  onclick="addcommentlike(' + postcomment.id + ',' + userid + ',' + postid + ')">Like</a>';
            ...
            if (postcomment.replies) {
                postcomment.replies.forEach((reply) => {
                    ...
                    if (reply.user.profileFilepath != null && reply.user.profileFilename != null) {
                        str += '<img alt="" src="' + reply.user.profileFilepath + '/' + reply.user.profileFilename + '" style="width:26px;">';
                    } else {
                        str += '<img alt="" src="/assets/img/profiles/avatar-16.jpg" style="width:26px ;">';
                    }
                    str += '</a>' +
                        '</div>' +
                        '<div class="form-control" style="border-radius: 24px;">' +
                    ...
                    if ((reply.replytagmembers).length > 0) {
                        str += '<span style="color: rgb(34 32 32 / 50%);"> -in Reply to </span>';
                        reply.replytagmembers.forEach((tagmember) => {
                            if (reply.id == tagmember.reply_id && tagmember.isReply == true) {
                                str += '<a href = "/user/view/' + tagmember.user.id + '" > ' + tagmember.user.firstname + ' ' + tagmember.user.lastname + ' </a>';
                            }
                        });
                    }
                    str += '<p>' + reply.comment_data + '</p>';
                    if (reply.replyfiles) {
                        reply.replyfiles.forEach((file) => {
                            if (reply.id == file.reply_id) {
                                str += '<ul class="attach-list">' +
                                    '<li><i class="fa fa-file"></i> <a href="/postcommentfiles/downloadfile/' + file.id + '">' + file.filename + '</a></li>' +
                                    '</ul>';
                            }
                    ...
                    if (reply.creation_date != null) {
                        str += '<span class="chat-time">Replied At ' + reply.creation_date + '</span>';
                    }
                    str += '</div>' +
                        '</div>' +
                        ' <div class="row" style="height: 25px;">' +
                        '<div class="likecount" id="replylikes_' + reply.id + '">';
                    if ((reply.replylikes.length) > 0) {
                        str += '<span class="iconify" data-icon="uiw:like-o" style="color:blue;"></span>' +
                    ...
                    str += '</div>' +
                        ...
                        '<a href="#reply_' + postcomment.id + '" style="cursor: pointer;color:black" onclick="showreplyform(' + postcomment.id + ');">Reply</a>';
                    if ((reply.replylikes.length) > 0) {
                        reply.replylikes.forEach((replylike) => {
                            if (replylike.reply_id == reply.id && replylike.isLiked == true) {
                                str += '<a id="replylike_' + reply.id + '" style="cursor: pointer; color:blue" onclick="addreplylike(' + reply.id + ', ' + reply.post_id + ')">Like</a>';
                            } else {
                                str += '<a id="replylike_' + reply.id + '" style="cursor: pointer; color:black" onclick="addreplylike(' + reply.id + ', ' + reply.post_id + ')">Like</a>';
                            }
                        });
                    } else {
                        str += '<a id="replylike_' + reply.id + '" style="cursor: pointer; color:black" onclick="addreplylike(' + reply.id + ', ' + reply.post_id + ')">Like</a>';
            ...
            str += '</a>' +
                ...
                ' <div class="btn-file" style="padding:10px">' +
                '<a data-toggle="modal" data-target="#tagpeople">' +
                '<input class="form-control" accept="image/jpeg,image/jpg,image/gif,image/png" id="images_' + postcomment.id + '" name="images" type="file" multiple />' +
                '<img src="/assets/img/group.png" alt="" style="width: 20px;">' +
                '</a>' +
                '</div>' +

                '<div class="btn-file" style="padding:10px">' +
                '<button type="submit" class="btn btn-info" onclick="postreply(' + postcomment.post_id + ', ' + userid + ', ' + postcomment.id + ')">Post</button>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
    ...
    function postcomment(postid, userid) {
        ...
        if (file_data.length > 0) {
            for (var i = 0; i < file_data.length; i++) {
                ...
                console.log(isFileNotAttached, 'hhhhh');
            }
        } else {
        ...
        $.ajax({
            ...
            data: form_data,
            success: function(data) {
                renderMessages(data, postid, userid);
            },
            error: function(data) {}
        });
    }
    ...
    function postreply(postid, userid, commentid) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // renderReplymessages(data, postid, userid);
            ...
            success: function(data) {
                ...
                if (data['count'] != 0) {
                    ...
                    str += '<span class="iconify" data-icon="uiw:like-o" style="color:blue;"></span>' +
                        ...
                        ' <a class="likedpeoples" data-toggle="modal" data-target="#comment_likedpeople_' + commentid + '" >Peoples</a>' +
                        ' <div class="modal custom-modal fade" id="comment_likedpeople_' + commentid + '" role="dialog">' +
                        '<div class="modal-dialog modal-dialog-centered">' +
                        '<div class="modal-content">' +
                        '<div class="modal-body">' +
                        '<div class="form-header">' +
                        ...
                        '<h3>Members</h3>' +
                        '</div>';
                    if (data['commentlikes'].postcommentlikes) {
                        data['commentlikes'].postcommentlikes.forEach((like) => {
                            str += '<div class="card">' +
                                '<h4 class="table-avatar">';
                            if (like.user.profileFilepath != null && like.user.profileFilename) {
                                str += '<a href="/user/view/' + like.user.id + '" class="avatar"><img src="' + like.user.profileFilepath + '/' + like.user.profileFilename + '" alt=""></a>';
    ...
    function addreplylike(reply_id, postid) {

        $.ajax({
            url: '/postcommentlikes/updatereplylikes',
            method: 'post',
            dataType: 'json',
            data: {
                'reply_id': reply_id,
            ...
            success: function(data) {
                ...
                $('#replylikes_' + reply_id).empty();
                var str = "";
                if (data['count'] != 0) {
                    str += '<span class="iconify" data-icon="uiw:like-o" style="color:blue;"></span>' +
                        '<span>' + data['count'] + '</span>' +
                        ' <a class="likedpeoples" data-toggle="modal" data-target="#reply_likedpeople_' + reply_id + '" >Peoples</a>' +
                        ' <div class="modal custom-modal fade" id="reply_likedpeople_' + reply_id + '" role="dialog">' +
                        '<div class="modal-dialog modal-dialog-centered">' +
                        '<div class="modal-content">' +
                        '<div class="modal-body">' +
                        '<div class="form-header">' +
                        ...
                        '<h3>Members</h3>' +
                        '</div>';
                    if (data['replylikes'].replylikes) {
                        data['replylikes'].replylikes.forEach((like) => {
                            str += '<div class="card">' +
                                '<h4 class="table-avatar">';
                            if (like.user.profileFilepath != null && like.user.profileFilename) {
                                str += '<a href="/user/view/' + like.user.id + '" class="avatar"><img src="' + like.user.profileFilepath + '/' + like.user.profileFilename + '" alt=""></a>';
                ...
                if (data['replylikes'].isLiked == true) {
                    $("#replylike_" + reply_id).attr("style", "color: blue;");
                } else {
                    $("#replylike_" + reply_id).attr("style", "color: black;");
                }


                $('#replylikes_' + reply_id).html(str);
            },
            error: function(a, b, c) {
                console.log(a);
                console.log(b);
    ...
    function updatepost(postid, group_id, userid) {
    ...
    function togglediv() {
        if ($('#textdiv').height() < 100) {
            $('#textdiv').height("100px");
            $('.tagpeopledive').show();
        } else {
            $('#textdiv').height("32px");
            $('.tagpeopledive').hide();
