            ...
            <?php foreach ($authcompanymember->designation->usermodulepermissions as $usermodule) : ?>
                <?php if ($usermodule->module->name == 'Tickets' && $usermodule->isAccessed == true && $usermodule->isRead == true) : ?>
                    ...
                    foreach ($alltickets as $ticket) {
                        if ($ticket->status == 'T') {
                            $todotickets = $todotickets + 1;
                        } elseif ($ticket->status == 'I') {
                            $pendingtickets = $pendingtickets + 1;
                        } else {
                            $resolvedtickets = $resolvedtickets + 1;
                        }
                    }
                    $totaltickets = $todotickets + $pendingtickets + $resolvedtickets;
                    ?>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">
                                            <div>
                                                <span class="d-block"><?= __('New Tickets') ?></span>
                                            </div>
                                            <div>
                                                <?php
                                                if (!empty($todotickets)) {
                                                    $openprogress = round($todotickets / ($totaltickets) * 100);
                                                    $resolvedprogress = round($resolvedtickets / ($totaltickets) * 100);
                                                    $pendingprogress = round($pendingtickets / ($totaltickets) * 100);
                                                } else {
                                                    $openprogress = 0;
                                                    $resolvedprogress = 0;
                                                    $pendingprogress = 0;
                                                ...
                                                <span class="text-success">+<?= $openprogress ?>%</span>
                                            </div>
                                        </div>
                                        <h3 class="mb-3"><?= $todotickets ?></h3>
                                        <div class="progress mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $openprogress ?>%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-3">
                                            ...
                                            <div>
                                                <span class="text-success">+<?= $pendingprogress ?>%</span>
                                            </div>
                                        </div>
                                        <h3 class="mb-3"><?= $pendingtickets ?></h3>
                                        <div class="progress mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $pendingprogress ?>%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-3">
                                            ...
                                            <div>
                                                <span class="d-block"><?= __('Resolved Tickets') ?></span>
                                            </div>
                                            <div>
                                                <span class="text-success">+<?= $resolvedprogress ?>%</span>
                                            </div>
                                        </div>
                                        <h3 class="mb-3"><?= $resolvedtickets ?></h3>
                                        <div class="progress mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar" style="width: <?= $resolvedprogress ?>%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between mb-3">
                                            ...
                                            <div>
                                                <span class="d-block"><?= __('Total Tickets') ?></span>
                                            </div>
                                            <div>
                                                <!--  <span class="text-danger">-75%</span> -->
                                            </div>
                                        </div>
                                        <h3 class="mb-3"><?= $totaltickets ?></h3>
                                        <div class="progress mb-2" style="height: 5px;">
