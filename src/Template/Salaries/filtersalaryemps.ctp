        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="/companies-user/salary/<?= $companyId ?>/" class="btn add-btn"> Go Back</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-striped custom-table datatable">
                        ...
                        <tbody>
                            <?php foreach ($matchedemps as $employee) : ?>
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar">
                                                <?php if ($employee->user->profileFilepath != null && $employee->user->profileFilename != null) : ?>
                                                    <img src="<?= $employee->user->profileFilepath ?>/<?= $employee->user->profileFilename ?>" alt="">
                                                <?php else : ?>
                                    ...
                                    <td>--</td>
                                    <td><a class="btn btn-sm btn-primary" href="/salaries/viewpayslip?empid=<?= $employee->user_id ?>&companyId=<?= $employee->company_id ?>">Generate Slip</a></td>
                                    <td class="text-right">
