                            ...
                            <div class="row">
                                ...
                                <div class="col-auto top-action-right">
                                    <div class="text-right">
                                        <button type="button" title="Refresh" id="refresh" data-toggle="tooltip" class="btn btn-white d-none d-md-inline-block"><i class="fa fa-refresh"></i></button>
                                        <div class="btn-group">
                            ...
                            <div class="table-responsive">
                                <table id="myTable" class="table table-inbox table-hover">
                                    ...
                                    <?php foreach ($projectemails as $key => $projectemail) : ?>
                                            <?php if (/* $projectemail->fromuser_id != $user_id &&  */$projectemail->rootmail_id == null) : ?>
                                                <?php $total = 0;
                                                $total = count($projectemail->childmails) ?>

                                                <?php $totalforwards = 0; ?>
                                                <?php foreach ($forwardemails as $forwardemail) : ?>
                                                    <?php if ($forwardemail->forwarded_id == $projectemail->id) : ?>
                                                        <?php $forwardcount = array();
                                                        array_push($forwardcount, $forwardemail->forwarded_id);

                                                        $totalforwards = count($forwardcount);
                                                        ?>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                                <?php if ($projectemail->isRead == false) : ?>
                                                    <tr id="myrow_<?= $key ?>" class="unreadmails">
                                                        ...
                                                        <?php endif; ?>
                                                        <?php if ($projectemail->childmails) : ?>

                                                            <?php debug($projectemail->childmails);
                                                            exit; ?>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php if ($total > 0) : ?>
                                                            <td class="subject"> <a href="/projectemail/view/<?= $projectemail->id ?>">
                                                                    <div onclick="isread(<?= $projectemail->id ?>)" style="width: 100%;height: 100%;color: black;"> <?= $projectemail->subject ?> <span style="color: black;">(<?= $total ?>)</span></div>
                                                                </a></td>

                                                        <?php elseif ($totalforwards > 0 && $projectemail->from_user->id != $user_id) : ?>
                                                            <td class="subject"> <a href="/projectemail/view/<?= $projectemail->id ?>">
                                                                    <div onclick="isread(<?= $projectemail->id ?>)" style="width: 100%;height: 100%;color: black;"><?= $projectemail->subject ?> <span style="color: black;">(<?= $totalforwards ?>)</span></div>
                                                                </a></td>
                                                        <?php else : ?>
                                                            <td class="subject"> <a href="/projectemail/view/<?= $projectemail->id ?>">
                                                ...
                                                <?php if ($projectemail->isRead == true) : ?>
                                                    <tr id="myrow_<?= $key ?>" class="readmails" style="color: blueviolet;">
                                                        ...
                                                        <?php elseif ($totalforwards > 0 && $projectemail->from_user->id != $user_id) : ?>
                                                            <td class="subject"> <a href="/projectemail/view/<?= $projectemail->id ?>">
                                                                    <div onclick="isread(<?= $projectemail->id ?>)" style="width: 100%;height: 100%;color: blueviolet;"><?= $projectemail->subject ?> <span style="color: black;">(<?= $totalforwards ?>)</span></div>
                                                                </a></td>
                                                        <?php else : ?>
                                                            <td class="subject"> <a href="/projectemail/view/<?= $projectemail->id ?>">
