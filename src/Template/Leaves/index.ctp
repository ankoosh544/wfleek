    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('leavetype') ?></th>
                <th scope="col"><?= $this->Paginator->sort('fromdate') ?></th>
                <th scope="col"><?= $this->Paginator->sort('todate') ?></th>
                <th scope="col"><?= $this->Paginator->sort('leavereason') ?></th>
                <th scope="col"><?= $this->Paginator->sort('medical_number') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $leave->has('user') ? $this->Html->link($leave->user->id, ['controller' => 'User', 'action' => 'view', $leave->user->id]) : '' ?></td>
                <td><?= h($leave->leavetype) ?></td>
                <td><?= h($leave->fromdate) ?></td>
                <td><?= h($leave->todate) ?></td>
                <td><?= h($leave->leavereason) ?></td>
                <td><?= $this->Number->format($leave->medical_number) ?></td>
                <td><?= h($leave->creation_date) ?></td>
                <td class="actions">
