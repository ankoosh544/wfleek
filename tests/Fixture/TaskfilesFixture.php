 ...
 * TaskfilesFixture
 */
class TaskfilesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'pid' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'tid' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'tid' => ['type' => 'index', 'columns' => ['tid'], 'length' => []],
            'user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'taskfiles_ibfk_1' => ['type' => 'foreign', 'columns' => ['tid'], 'references' => ['projecttasks', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'taskfiles_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['user', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'size' => 1,
                'isDeleted' => 1,
                'creation_date' => '2022-02-25 22:24:47'
            ],
        ];
        parent::init();
    }
