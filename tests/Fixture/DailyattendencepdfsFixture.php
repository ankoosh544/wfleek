...
/**
 * DailyattendencepdfsFixture
 */
class DailyattendencepdfsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'month' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'creation_date' => '2022-02-01 09:27:31'
            ],
        ];
        parent::init();
    }
