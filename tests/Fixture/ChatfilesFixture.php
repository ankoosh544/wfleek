 ...
 * ChatfilesFixture
 */
class ChatfilesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'chatfiles_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['user', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'chatfiles_ibfk_2' => ['type' => 'foreign', 'columns' => ['touser_id'], 'references' => ['user', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'size' => 1,
                'isDeleted' => 1,
                'creation_date' => '2021-10-03 10:36:45'
            ],
        ];
        parent::init();
    }
