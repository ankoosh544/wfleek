...
class SettingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'two_factor_authentication' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'settings_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['user', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'settings_ibfk_2' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['usercompanies', 'id'], 'update' => 'setNull', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
