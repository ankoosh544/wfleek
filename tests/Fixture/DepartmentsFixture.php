...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'departments_ibfk_1' => ['type' => 'foreign', 'columns' => ['company_id'], 'references' => ['companies_user', 'company_id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'creation_date' => '2022-04-14 04:05:18',
                'isDeleted' => 1
            ],
        ];
        parent::init();
