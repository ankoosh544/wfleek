...
class InvoiceitemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'invoiceId' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'invoiceId' => ['type' => 'index', 'columns' => ['invoiceId'], 'length' => []],
        ],
        '_constraints' => [
