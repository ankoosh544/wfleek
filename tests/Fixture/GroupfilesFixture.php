 ...
 * GroupfilesFixture
 */
class GroupfilesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'groupfilepost_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'groupfilepost_id' => ['type' => 'index', 'columns' => ['groupfilepost_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'size' => 1,
                'creation_date' => '2022-02-02 09:44:06',
                'isDeleted' => 1
            ],
        ];
        parent::init();
