...
/**
 * GrouppostfilesFixture
 */
class GrouppostfilesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'grouppost_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'grouppost_id' => ['type' => 'index', 'columns' => ['grouppost_id'], 'length' => []],
