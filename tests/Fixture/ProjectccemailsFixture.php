...
/**
 * ProjectccemailsFixture
 */
class ProjectccemailsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'ccemail_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'ccemail_id' => ['type' => 'index', 'columns' => ['ccemail_id'], 'length' => []],
        ],
        '_constraints' => [
