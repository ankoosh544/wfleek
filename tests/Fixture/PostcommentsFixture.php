...
class PostcommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'parent_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'comment_data' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'isDeleted' => 1,
                'creation_date' => '2022-01-21 07:09:51'
            ],
        ];
        parent::init();
    }
