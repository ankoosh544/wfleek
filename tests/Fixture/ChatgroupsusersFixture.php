...
/**
 * ChatgroupsusersFixture
 */
class ChatgroupsusersFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'chatgroupsusers_ibfk_1' => ['type' => 'foreign', 'columns' => ['group_id'], 'references' => ['chatgroups', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
