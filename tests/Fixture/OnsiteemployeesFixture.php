...
/**
 * OnsiteemployeesFixture
 */
class OnsiteemployeesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'work_location_Id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'work_categoryId' => ['type' => 'index', 'columns' => ['work_location_Id'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'work_location_Id' => 1,
                'user_id' => 1,
                'creation_date' => '2021-11-16 20:32:59',
                'isDeleted' => 1
            ],
        ];
        parent::init();
